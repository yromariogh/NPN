...
import numpy as np
class E2E_Modulated_Input(nn.Module):
    def __init__(self, optical_layer: nn.Module, decoder: nn.Module ,t):
        r""" 
        ...
        """
        super(E2E_Modulated_Input, self).__init__()
        self.optical_layer = optical_layer
        self.linear = nn.Linear(t, self.optical_layer.learnable_optics.shape[-1])
        self.decoder = decoder
